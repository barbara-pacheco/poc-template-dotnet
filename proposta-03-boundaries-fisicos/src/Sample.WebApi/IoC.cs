...
/// <summary>
/// Composition root do WebApi: registra o que é responsabilidade do host
/// HTTP — Problem Details, o exception handler global, a descoberta
/// automática de endpoints e o Swagger. Chamado uma vez no Program.cs.
/// </summary>
public static class IoC
{
    public static IServiceCollection AddWebApi(this IServiceCollection services)
    {
        ...
        services.AddEndpoints(typeof(IoC).Assembly);
